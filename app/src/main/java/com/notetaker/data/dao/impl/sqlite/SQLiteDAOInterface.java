package com.notetaker.data.dao.impl.sqlite;
...
public class SQLiteDAOInterface implements DAOInterface {

    private static final String TAG = SQLiteDAOInterface.class.getSimpleName();
    ...
    @Inject
    public SQLiteDAOInterface(@Named("NotesDbHelper") SQLiteOpenHelper databaseHelper) {
    ...
    public void delete(Note note) {
        ...
        try {
            ...
            Log.e(TAG, "Could not delete [" + note + "]", ex);
        } finally {
            database.endTransaction();
            database.close();
        }
